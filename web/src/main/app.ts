...
function applyDefaults(opts : DeepPartial<AppOptions>) : AppOptions {
    const
        ...
        chunkDeltaOpts = canvasOpts.chunkDelta || {},
    ...
    return {
        canvas: {
            ...
            chunkDelta: {
                re: chunkDeltaOpts.re !== undefined ? chunkDeltaOpts.re : CANVAS_DEFAULTS.chunkDelta.re,
                im: chunkDeltaOpts.im !== undefined ? chunkDeltaOpts.im : CANVAS_DEFAULTS.chunkDelta.im
            }
        },
        escapeTime: {
            c: {
